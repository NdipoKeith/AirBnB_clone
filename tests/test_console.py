...
- TestHBNBCommandPrompting: Test HBNB command interpreters prompting
- TestHBNBCommandHelp: Test the HBNB command interpreters help messages
- TestHBNBCommandExit: Test the HBNB command interpreters exit commands
